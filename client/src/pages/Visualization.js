...
const Visualization = (props) => {
  ...
  return (
    <>
    {showDetail && <DetailReport type="Crack" status="Not OK"   onClose={hideDetailHandler} frameName={name}/>}
    <Header />
    {!showReport && <>
      <Frame />
      <Chart />
      <ButtonContainer onConfirm={showReportHandler}/></>}
    {showReport && <Report onConfirm={hideReportHandler} onShowDetail={showDetailHandler}/>}
